	...
	coroutine.create(
		function()
            local succ, er = pcall(function()
                ...
                local WalkSpeed = 17
                local WalkBool, WalkText, defaultWalkSpeed = false, "", game:GetService("Players").LocalPlayer.Character.Humanoid.WalkSpeed

                local function walkSpeedFunction(actionName, inputState)
                    if inputState == Enum.UserInputState.Begin then
                        
                        WalkBool = not WalkBool
                ...
                game:GetService("ContextActionService"):BindAction("walkSpeedFunction", walkSpeedFunction, false, Enum.KeyCode.F1) -- Change to any key
